                        ...
                        <fieldset class="border rounded border-gray-300 p-3">
                            ...
                            <div class="grid grid-rows-2 grid-flow-col gap-4">
                                ...
                                <div class="mb-1 row-span-1 w-full">
                                    ...
                                    &nbsp;&nbsp;&nbsp;<a href="#" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="manualdeusuario">MANUAL DE USUARIO</a><br><br>
                                    &nbsp;&nbsp;&nbsp;<a href="#" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="manualtecnico" >MANUAL TÉCNICO</a>
                                </div>
                                ...
                                <div class="mb-1 row-span-2">
                                    <div class="mb-1">
                                    <center>
                                        <h3 class="font-semibold text-xl text-Gray-700">DATOS DE CONTACTO</h3><br>
                                    </center>
                                    <div>
                                        <iframe src="{{ asset('docs/manualdeusuario.pdf') }}" frameborder="1" width="100%" height="550"  overflow="hidden">
                                        </iframe>
                                    </div>
                                </div>
                                </div>
